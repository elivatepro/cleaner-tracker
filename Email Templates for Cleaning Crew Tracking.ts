...
// Usage: import { getInvitationEmail } from '@/lib/email-templates';
//
...
function summaryRow(label: string, value: string): string {
  return `
    <tr>
      <td style="padding:10px 0;border-bottom:1px solid #333333;font-size:14px;color:#6B6B6B;width:140px;">${label}</td>
      <td style="padding:10px 0;border-bottom:1px solid #333333;font-size:14px;color:#FFFFFF;font-weight:500;">${value}</td>
    </tr>
  `;
}
